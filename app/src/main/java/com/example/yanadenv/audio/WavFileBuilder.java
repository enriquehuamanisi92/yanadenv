...
public class WavFileBuilder {
     ...
     */
    public static final int SAMPLE_RATE_4000 = 4000;
    ...
    public WavFileBuilder setSubChunk1Size(int size) {
    ...
    public WavFileBuilder setAudioFormat(int format) {
    ...
    public WavFileBuilder setNumChannels(int channels) {
    ...
    public WavFileBuilder setSampleRate(int sampleRate) {
    ...
    public WavFileBuilder setBitsPerSample(int bitsPerSample) {
